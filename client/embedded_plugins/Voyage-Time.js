...
class VoyageTime {
  ...
  update() {
    ...
    const energySentElement = this.#element.querySelector('code[data-energy-sent]');
    energySentElement.innerText = computedVoyageEnergy?.sent
      ? formatEnergy(computedVoyageEnergy?.sent)
      : 'n/a';

    const energyArrivingElement = this.#element.querySelector('code[data-energy-arriving]');
