...
// Type imports
import {RevealedCoords, ArrivalData, Planet, PlanetEventType,
PlanetEventMetadata, PlanetDefaultStats, PlanetData, Player,
ArtifactWithMetadata, Upgrade, Artifact, ClaimedCoords} from "../DFTypes.sol";
...
contract DFGetterOneFacet is WithStorage {
    ...
    function bulkGetUnionIds(uint256 startIdx, uint256 endIdx) public view returns (uint256[] memory ret) {
        return _bulkGetArray(gs().unionIds, startIdx, endIdx);
    }
